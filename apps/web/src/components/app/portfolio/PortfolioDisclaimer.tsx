 ...
 * platform-wide "Modo Simulador" badge is rendered separately and
...
export function PortfolioDisclaimer() {
  return (
    ...
    >
      Todas las cifras de esta página son simuladas: saldo, ganancias,
      posiciones y transacciones no representan dinero real.
    </p>
  );
}
