 ...
 * platform-wide "Modo Simulador" badge is already rendered unconditionally
  ...
  return (
    <div className="flex flex-col gap-8">
      <header className="flex flex-col gap-3">
        <h1 className="text-3xl font-bold tracking-tight text-ink">Invertir</h1>
        <InvestDisclaimer />
      </header>
